...
export const libraryEntries: LibraryEntry[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        diagram: "Flow: Asset Dump → Text Extraction → Translation → Injection → In-Game QC"
      },
      {
        id: "challenges",
        number: "05",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        diagram: "Flow: Introduction → Mechanics → Narrative → Representation → Conclusion"
      },
      {
        id: "challenges",
        number: "05",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        diagram: "Flow: Capture Request → Match Rules → Apply Disruption → Forward → Log Outcome"
      },
      {
        id: "challenges",
        number: "05",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        diagram: "Flow: Setup → Draft Phase → Composition Phase → Invocation Phase → Scoring"
      },
      {
        id: "challenges",
        number: "05",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        diagram: "Flow: Turn Input → Action Validation → Simulation → Resolution → State Update"
      },
      {
        id: "challenges",
        number: "05",
  ...
  },
  {
    ...
    summary: "Pix 是一个通过 NPM 分发的 Windows CLI 工具，用于将 Pi Coding Agent 的运行环境从宿主系统中解耦，并统一编排 Windows、WSL2 与 Docker Desktop 之间的执行链路。",
    date: "2026",
    year: 2026,
    type: "tool",
    category: "Tools",
    ...
    stack: ["Node.js", "WSL2", "Docker Desktop", "Mutagen", "rsync", "Pi Coding Agent"],
    ...
    sections: [
      ...
      },
      {
        ...
        outcome: {
          ...
          summary: "为 Coding Agent 在 Windows、WSL2 与 Docker 之间建立统一、可控且连续的执行边界。",
          intent: [
            {
              code: "BOUNDARY",
